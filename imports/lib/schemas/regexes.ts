...
export const UUID = /^([a-fA-F0-9]{8}-[a-fA-F0-9]{4}-[1-5][a-fA-F0-9]{3}-[a-fA-F0-9]{4}-[a-fA-F0-9]{12}|00000000-0000-0000-0000-000000000000)$/;
...
export const URL = /[hH][tT][tT][pP][sS]?:\/\/((?!-))(xn--)?[a-z0-9][a-z0-9-_]{0,61}[a-z0-9]{0,1}\.(xn--)?([a-z0-9-]{1,61}|[a-z0-9-]{1,30}\.[a-z]{2,})(:[0-9]{0,5})?(\/[a-z0-9\-._~:/?#[\]@!$&'()*+,;=%]*)?#?/;
