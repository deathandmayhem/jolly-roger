...
> extends Model<
  ...
  findOne<S extends Selector<ModelType<this>>, O extends Omit<Mongo.Options<ModelType<this>>, 'limit' | 'transform'>>(
    selector?: S,
    options?: O,
  ...
  findOneAsync<S extends Selector<ModelType<this>>, O extends Omit<Mongo.Options<ModelType<this>>, 'limit' | 'transform'>>(
    selector?: S,
    options?: O,
