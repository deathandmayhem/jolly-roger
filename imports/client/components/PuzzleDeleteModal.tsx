...
const PuzzleDeleteModal = ({
  puzzle,
  ref,
}: {
  puzzle: PuzzleType;
  ref: React.Ref<PuzzleDeleteModalHandle>;
}) => {
  ...
  const deletePuzzle = useCallback(() => {
    destroyPuzzle.call({
      ...
      copySheetsToReplacement:
        thisPuzzleHasSheets && replacementHasSheets && copySheetsToReplacement,
    });
  ...
  const modal = (
    <Modal show={visible} onHide={hide}>
      ...
      <Modal.Body>
        ...
        >
          <p>
            Are you sure you want to delete this puzzle? Anyone actively working
            on this puzzle will lose the ability to make further edits or chat
            comments.
          </p>
          <p>
            You can optionally specify a replacement to be used instead of this
            puzzle and copy the sheets over (if applicable)
          </p>
          <Select
            isClearable
