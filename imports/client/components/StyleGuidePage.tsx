...
const ModalSection = () => {
  ...
  return (
    <section className="space-y-4">
      <h2 className="text-2xl font-bold font-display">Modal</h2>
      <p className="text-sm opacity-60">
        Native dialog element opened with{" "}
        <code className="font-mono text-xs">showModal()</code>. Esc and the
        backdrop form close it. While open, daisyUI locks page scrolling; that
        works here because the scope-tailwind postcss plugin hoists the
        :root-targeting lock rule out of{" "}
        <code className="font-mono text-xs">@scope</code> (see the consumer in
        tailwind.css).
      </p>

      <AnnotatedExample
        title="Dialog modal"
        annotation='<dialog className="modal"> + modal-box, modal-action, modal-backdrop'
      >
        <button
          type="button"
        ...
        <dialog ref={modalRef} className="modal">
          <div className="modal-box">
            <h3 className="text-lg font-bold">Confirm solve</h3>
            <p className="py-4">
              Mark <span className="font-semibold">Star Charts</span> as solved
              with answer{" "}
              <span className="font-mono tracking-wider">CONSTELLATION</span>?
            </p>
