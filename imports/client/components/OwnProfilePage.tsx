...
// Form field wrapper component with inline status indicator. Children receive
// a generated id to put on the form control so the label is associated with it.
const FormField = ({
  label,
  hint,
  status,
...
const AudioDeviceSelector = () => {
  ...
  // Keep the selection in sync when another tab changes the stored preference
  useEffect(() => {
        ...
        {(id) => (
          ...
          >
            ...
            {preferredDeviceId !== undefined &&
              !knownDevices.some(
                (dev) => dev.deviceId === preferredDeviceId,
              ) && (
        ...
        >
          {(id) => (
            <input
              ...
              className="input w-full"
              placeholder={t(
                "profile.phoneNumber.placeholder",
                "+1 555-555-5555",
              )}
            />
          )}
        ...
        >
          {(id) => (
            <input
              ...
              className="input w-full"
              placeholder={t(
                "profile.dingwords.placeholder",
                "e.g. cryptic, crossword, logic",
              )}
            />
          )}
        </FormField>
...
const AccountSection = ({ user }: { user: Meteor.User }) => {
  ...
  return (
    <SettingsSection title={t("profile.account.title", "Account")}>
      ...
      <fieldset className="fieldset">
        <div className="label">
          <label className="font-medium" htmlFor={`${id}-add-email`}>
          ...
          <div className="space-y-3 p-4 border border-base-300 rounded-lg">
            ...
            <fieldset className="fieldset">
              <div className="label py-1">
                <label className="text-sm" htmlFor={`${id}-current-password`}>
            ...
            <fieldset className="fieldset">
              <div className="label py-1">
                <label className="text-sm" htmlFor={`${id}-new-password`}>
            ...
            <fieldset className="fieldset">
              <div className="label py-1">
                <label className="text-sm" htmlFor={`${id}-confirm-password`}>
