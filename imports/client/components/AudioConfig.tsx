...
const AudioConfig = () => {
  ...
  const { t } = useTranslation("AudioConfig");
  ...
  return (
    <section>
      ...
      >
        <FormLabel>
          {t("selectedInput", "Selected audio input device")}
        </FormLabel>
        <FormControl
          as="select"
      ...
      <p>{t("testAudio.intro", "You can test your microphone levels here.")}</p>

      <p>
        {t(
          "testAudio.instruction",
      ...
      {status !== AudioConfigStatus.STREAMING ? (
        <Button variant="secondary" onClick={onStartButtonClicked}>
          {t("testAudio.Start", "Start")}
        </Button>
      ) : (
        <Button variant="secondary" onClick={onStopButtonClicked}>
          {t("testAudio.Stop", "Stop")}
        </Button>
      )}

      <p>
        {t(
          "testAudio.playBackHelp",
      ...
      >
        <FormCheck
          type="checkbox"
          label={t("testAudio.playBack", "Play captured audio")}
          checked={loopback}
