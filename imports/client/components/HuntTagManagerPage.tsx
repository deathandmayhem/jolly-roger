...
const RenameTagSection = ({ huntId }: { huntId: string }) => {
  ...
  const { t } = useTranslation("HuntTagManagerPage");

  return (
    <section>
      <h2>{t("RenameTagSection.title", "Rename tag")}</h2>
      <p>
        {t(
          "RenameTagSection.description",
        ...
        <Row className="mb-3 align-items-end">
          <Col xs={5}>
            <FormGroup className="mb-3" controlId={`${idPrefix}-rename-source`}>
              <FormLabel>
                {t("RenameTagSection.selectLabel", "Tag to rename")}
              </FormLabel>
              <Select
          ...
          <Col xs={5}>
            ...
            >
              <FormLabel>
                {t("RenameTagSection.newNameLabel", "New name")}
              </FormLabel>
              <FormControl
                type="text"
          ...
          <Col xs={2}>
            <FormGroup className="mb-3">
              <Button variant="primary" type="submit" disabled={disableRename}>
                {t("RenameTagSection.renameButton", "Rename")}
              </Button>
            </FormGroup>
          </Col>
        </Row>
      ...
      <StyledTable>
        <thead>
          <tr>
            ...
            <th>{t("SelectablePuzzleList.Puzzle", "Puzzle")}</th>
            <th>{t("SelectablePuzzleList.Tags", "Tags")}</th>
          </tr>
        </thead>
...
const BulkAddRemoveSection = ({
  ...
  return (
    <section>
      <h2>{t("BulkAddRemoveSection.title", "Bulk add/remove tags")}</h2>
      <p>
        {t(
          "BulkAddRemoveSection.description",
      ...
      <SearchFormGroup controlId={`${idPrefix}-puzzle-search`}>
        <InputGroup>
          <FormControl
            ...
            type="text"
            ref={searchBarRef}
            placeholder={t("filterBy", "Filter by title, answer, or tag")}
            value={searchString}
      ...
      <PuzzleListToolbar>
        <span>
          {t(
            "BulkAddRemoveSection.showCount",
        ...
        <span>
          {t("BulkAddRemoveSection.selected", "{{count}} selected", {
      ...
      <Row className="mb-3 align-items-end">
        <FormGroup as={Col} xs={5} controlId={`${idPrefix}-bulk-selected-tags`}>
          ...
          >
            {t("BulkAddRemoveSection.tagsToApply", "Tag to apply")}:
          </label>
          <Select
        ...
        <FormGroup as={Col} xs={7}>
          <ButtonGroup>
            ...
            >
              ...
              {t("BulkAddRemoveSection.add", "Add to {{count}} selected", {
