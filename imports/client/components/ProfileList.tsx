...
const PromoteOperatorModal = ({
  ...
  return (
    <ConfirmationModal
      title={t("Promote Operator", "Promote Operator")}
      body={body}
      action={t("Promote", "Promote")}
...
const DemoteOperatorModal = ({
  ...
  return (
    <ConfirmationModal
      title={t("Demote Operator", "Demote Operator")}
      body={body}
      action={t("Demote", "Demote")}
      performAction={performAction}
      ref={forwardedRef}
    />
  );
