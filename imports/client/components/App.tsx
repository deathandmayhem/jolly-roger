...
const ContentContainer = styled.div`
  ...
  /* Tailwind pages go full-bleed and manage their own padding (safe-area
   * insets for them are deferred until a page needs them). This relies on the
   * page's .tailwind-page root being a direct child: a wrapper element in
   * between silently restores the Bootstrap padding. */
  &:has(> .tailwind-page) {
    padding: 0;
  }
`;
