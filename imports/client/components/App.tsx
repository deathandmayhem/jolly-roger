          ...
          <DropdownMenu align="end">
            <RRBS.LinkContainer to={`/users/${userId}`}>
              <DropdownItem eventKey="1">
                {t("AppNavBar.MyProfile", "My profile")}
              </DropdownItem>
            </RRBS.LinkContainer>
            <DropdownItem
              eventKey="2"
