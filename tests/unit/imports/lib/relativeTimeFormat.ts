...
import en from "../../../../imports/locales/en/clientside/DateAndTime.json" with {
  type: "json",
};
import zh from "../../../../imports/locales/zh/clientside/DateAndTime.json" with {
  type: "json",
};
...
describe("relativeTimeFormat", function () {
  initTestI18n("en").then(function (t) {
...
describe("relativeTimeFormat_zh", function () {
  initTestI18n("zh").then(function (t) {
