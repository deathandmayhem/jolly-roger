...
const Popup = () => {
  ...
  const form = (
    <Form onSubmit={addPuzzle}>
      <Form.Group as={Row} className="mb-3" controlId={`${idPrefix}-hunt`}>
      ...
      <Form.Group as={Row} className="mb-3" controlId={`${idPrefix}-title`}>
        <Form.Label column xs={3}>
          Title
        </Form.Label>
        <Col xs={9}>
      ...
      {/* We can't use controlId since the checkbox is not associated with the label. */}
      <Form.Group as={Row} className="mb-3">
        <Form.Label column xs={3} htmlFor={`${idPrefix}-url`}>
          URL
        </Form.Label>
        <Col xs={9}>
          <Form.Control
      ...
      <Form.Group as={Row} className="mb-3" controlId={`${idPrefix}-tags`}>
        <Form.Label column xs={3}>
          Tags
        </Form.Label>
        <Col xs={9}>
      ...
      <Form.Group as={Row} className="mb-3" controlId={`${idPrefix}-doc-type`}>
        <Form.Label column xs={3}>
          Document type{" "}
          <OverlayTrigger
            overlay={
      ...
      <Form.Group
        as={Row}
        className="mb-3"
        controlId={`${idPrefix}-expected-answer-count`}
      >
        <Form.Label column xs={3}>
          Expected # of answers
        </Form.Label>
